		...
		<div class="container">
			...
			>
				<div class="form-group  row">
					...
					<div class="col-sm-3">
						<input name="m_id" type="text" class="form-control"
							value="<c:out value='${row.m_id }'/>" readonly="readonly"
						>
						<!-- readonly="readonly"속성을 주어서 수정불가로만듬 -->
					</div>
				</div>
				<div class="form-group  row">
				...
				<div class="form-group  row">
					...
					<div class="col-sm-10">
						...
						<input name="gender" type="radio" value="남성"
							<c:if test="${gender.equals('남성')}"> <c:out value="checked" /> </c:if>
						>
						남성
						<input name="gender" type="radio" value="여성"
							<c:if test="${gender.equals('여성')}"> <c:out value="checked" /> </c:if>
						>
						여성
					</div>
				</div>
